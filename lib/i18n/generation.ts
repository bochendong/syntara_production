export const generationZhCN = {
  ...
  generation: {
    ...
    generatingOutlines: '生成页面规划',
    generatingOutlinesDesc: '正在构建课程主线和逐页教学动作...',
    generatingSlideContent: '生成页面内容',
    generatingSlideContentDesc: '正在创建整页图片、测验和互动内容...',
    preparingImageGeneration: '准备并行生成图片',
    ...
    continue: '继续',
    // Outline errors
    outlineRetrying: '页面规划生成异常，正在重试...',
    outlineEmptyResponse: '模型未返回有效的页面规划，请检查模型配置后重试',
    outlineGenerateFailed: '页面规划生成失败，请稍后重试',
    // Web Search
    webSearching: '网络搜索',
...
export const generationEnUS = {
  ...
  generation: {
    ...
    generatingOutlines: 'Planning Notebook Pages',
    generatingOutlinesDesc: 'Building the course spine and page-by-page teaching moves...',
    generatingSlideContent: 'Generating Page Content',
    generatingSlideContentDesc: 'Creating full-page images, quizzes, and interactive content...',
    preparingImageGeneration: 'Preparing Parallel Image Generation',
    ...
    outlineReady: 'Page plan generated',
    ...
    continue: 'Continue',
    // Outline errors
    outlineRetrying: 'Page planning issue, retrying...',
    outlineEmptyResponse:
      'Model returned no valid page plan. Please check model configuration and try again',
    outlineGenerateFailed: 'Page planning failed, please try again later',
    // Web Search
