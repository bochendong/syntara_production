...
import type { NotebookProblemPublicContent } from './types';
import { cn } from '../../lib/cn';
import { highlightPython } from './code-answer-editor';
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="space-y-3 border-l border-slate-200 pl-4 dark:border-slate-800">
        ...
        {section.code ? (
          <CodeStatementCodeBlock
            code={section.code}
            language={section.codeLanguage || section.language}
          />
        ) : null}
      </div>
    </section>
