...
export function TeacherAppShell({
  ...
  return (
    <div
      data-testid={testId}
      className="min-h-full bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.08),transparent_28%),linear-gradient(180deg,#f8fafc,#eef2f7)] p-3 text-slate-950 dark:bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.1),transparent_30%),linear-gradient(180deg,#07111f,#020617)] dark:text-white sm:p-4"
    >
