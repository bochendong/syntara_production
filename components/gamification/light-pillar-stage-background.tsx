...
type LightPillarStageBackgroundProps = {
  className?: string;
  topColor?: string;
  bottomColor?: string;
  intensity?: number;
...
export function LightPillarStageBackground({
  className,
  topColor = '#5227FF',
  bottomColor = '#FF9FFC',
  intensity = 1,
  ...
  mixBlendMode = 'screen',
  quality = 'high',
}: LightPillarStageBackgroundProps) {
  ...
  if (!webGLSupported) {
    return <div className={className} style={{ position: 'absolute', inset: 0, mixBlendMode }} />;
  }
