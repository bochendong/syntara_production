...
export function StudentPortalHeader({
  ...
  return (
    <header className="relative isolate flex min-h-14 items-center justify-between gap-3 rounded-2xl border border-slate-200/80 bg-white/88 px-4 py-2.5 shadow-[0_14px_34px_rgba(15,23,42,0.055)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/70">
      <AiActivityLight />
