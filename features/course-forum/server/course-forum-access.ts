...
export async function requireCourseForumReadAccess(courseId: string): Promise<CourseForumAccessResult> {
...
export function forumAuthor(
  ...
  const forumRoleLabel = forumRole === 'admin' ? '管理员' : forumRole === 'teacher' ? '老师' : '学生';
