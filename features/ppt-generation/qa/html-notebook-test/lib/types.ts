...
export const LEGACY_STORAGE_KEY = 'syntara:html-notebook-generation-test:v3';
export const TEST_RESULT_ID = 'html-notebook';
export const TEST_RESULT_KEY = 'state';
export const HTML_LESSON_MODEL = 'gpt-5.4';
export const RESULT_RENDER_VERSION = 'html-notebook-v7';
...
export type HtmlSlideGenerationJobStatus =
  | 'queued'
  | 'running'
  | 'succeeded'
  | 'failed'
...
export interface HtmlSlideGenerationJob {
