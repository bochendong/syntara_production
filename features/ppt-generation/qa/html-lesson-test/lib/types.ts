...
export const LEGACY_STORAGE_KEY = 'syntara:html-lesson-generation-test:v1';
export const TEST_RESULT_ID = 'html-lesson';
export const TEST_RESULT_KEY = 'state';
export const HTML_LESSON_MODEL = 'gpt-5.4';
export const RESULT_RENDER_VERSION = 'html-lesson-v3';
